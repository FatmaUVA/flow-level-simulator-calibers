...
log_dir="/users/fha6np/simulator/9-7-code/avg-transfer-exp-300/results-global-sjf-ver-"+str(ver)+"/"
arrival_rate,rej1,util1 = np.loadtxt(log_dir+"new-arrival-"+network+"-uniform-avg-transfer-epoch-1-sim-time-86400-td-3600.csv",delimiter=',',usecols=(0, 1,2),unpack=True)
log_dir="/users/fha6np/simulator/9-7-code/avg-transfer-exp-300/results-global-ljf-ver-"+str(ver)+"/"
arrival_rate,rej2,util2 = np.loadtxt(log_dir+"new-arrival-"+network+"-uniform-avg-transfer-epoch-1-sim-time-86400-td-3600.csv",delimiter=',',usecols=(0, 1,2),unpack=True)
log_dir="/users/fha6np/simulator/9-7-code/avg-transfer-exp-300/results-local-ljf-ver-"+str(ver)+"/"
arrival_rate,rej3,util3 = np.loadtxt(log_dir+"new-arrival-"+network+"-uniform-avg-transfer-epoch-1-sim-time-86400-td-3600.csv",delimiter=',',usecols=(0, 1,2),unpack=True)
log_dir="/users/fha6np/simulator/9-7-code/avg-transfer-exp-300/results-local-sjf-ver-"+str(ver)+"/"
arrival_rate,rej4,util4 = np.loadtxt(log_dir+"new-arrival-"+network+"-uniform-avg-transfer-epoch-1-sim-time-86400-td-3600.csv",delimiter=',',usecols=(0, 1,2),unpack=True)
log_dir="/users/fha6np/simulator/9-7-code/avg-transfer-exp-300/results-naive-ljf-ver-2/"
...
#perf3_mblf_sjf_3 = (1-rej5)/(1-util5)
perf3_naive =  (1-rej5)/(1-util5)

arrival_rate = 1/ arrival_rate
print"arrival rate", arrival_rate

log_dir="/users/fha6np/simulator/9-7-code/plots-9-13/"
...
axes = plt.gca()
#axes.set_ylim([0,1])
plt.title('new-arrival-avg-transfer-300-epoch-1-sim-time-86400-td-3600')
plt.legend(title = "Algorithm:",loc='upper left')
file_name="ver-"+str(ver)+"-Performance-new-arrival-"+network+"-avg-transfer-300-epoch-1-sim-time-86400-td-3600-range-2"
...
file_name="ver-"+str(ver)+"-reject-utilization-new-arrival-"+network+"--avg-transfer-300-epoch-1-sim-time-86400-td-3600-range-2"
plt.savefig(log_dir+file_name+'.png', bbox_inches='tight')
